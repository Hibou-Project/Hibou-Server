...
class Settings:
    ...
    IPC_VIDEO_STREAMING_RAW_TOPIC: str
    IPC_VIDEO_STREAMING_ANNOTATED_TOPIC: str
...
try:
    ...
    SETTINGS = Settings(
        ...
        IPC_VIDEO_STREAMING_RAW_TOPIC=os.getenv("IPC_VIDEO_STREAMING_RAW_TOPIC"),
        IPC_VIDEO_STREAMING_ANNOTATED_TOPIC=os.getenv("IPC_VIDEO_STREAMING_ANNOTATED_TOPIC"),
    )
